  ...
  var persons = [
    {
      ...
      images: [
        {
          full: '/assets/images/1-full.jpg',
          thumb: '/assets/images/1-thumb.jpg'
        },
        {
          full: '/assets/images/2-full.jpg',
    ...
    },
    {
      ...
      images: [
        {
          full: '/assets/images/4-full.jpg',
          thumb: '/assets/images/4-thumb.jpg'
        },
        {
          full: '/assets/images/5-full.jpg',
          thumb: '/assets/images/5-thumb.jpg'
        },
        {
          full: '/assets/images/6-full.jpg',
    ...
    },
    {
      ...
      images: [
        {
          full: '/assets/images/7-full.jpg',
          thumb: '/assets/images/7-thumb.jpg'
        },
        {
          full: '/assets/images/8-full.jpg',
          thumb: '/assets/images/8-thumb.jpg'
        },
        {
          full: '/assets/images/9-full.jpg',
          thumb: '/assets/images/9-thumb.jpg'
        },
        {
          full: '/assets/images/10-full.jpg',
          thumb: '/assets/images/10-thumb.jpg'
        }
      ]
    },
  ];
